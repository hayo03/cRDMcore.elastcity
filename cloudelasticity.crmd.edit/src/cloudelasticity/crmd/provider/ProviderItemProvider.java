...
/**
 * This is the item provider adapter for a {@link cloudelasticity.crmd.Provider} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProviderItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 crmdPackage.Literals.PROVIDER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAccesskeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Provider_accesskey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Provider_accesskey_feature", "_UI_Provider_type"),
				 crmdPackage.Literals.PROVIDER__ACCESSKEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Secretkey feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSecretkeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Provider_secretkey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Provider_secretkey_feature", "_UI_Provider_type"),
				 crmdPackage.Literals.PROVIDER__SECRETKEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
