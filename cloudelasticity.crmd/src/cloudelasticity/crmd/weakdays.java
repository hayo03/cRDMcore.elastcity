...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>weakdays</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see cloudelasticity.crmd.crmdPackage#getweakdays()
 * @model
 * @generated
 */
public enum weakdays implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>weakdays</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final weakdays[] VALUES_ARRAY =
		new weakdays[] {
			MONDAY,
			TUESDAY,
			WEDNESDAY,
	...
	/**
	 * A public read-only list of all the '<em><b>weakdays</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<weakdays> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>weakdays</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static weakdays get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			weakdays result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>weakdays</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static weakdays getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			weakdays result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>weakdays</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static weakdays get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private weakdays(int value, String name, String literal) {
		this.value = value;
		this.name = name;
